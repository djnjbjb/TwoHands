...
namespace Ludo.TwoHandsWar.Circumstance.PlayerInput
{
    public class UniformInput : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            {
                Log.Logger.Log("✖ No Control device connected. No keyboard and no gamepad.");
            }
            if (keyboard != null)
            {
                Log.Logger.Log("✔ Keyboard connected.");
            }
            if (gamepad != null)
            {
                Log.Logger.Log("✔ Gamepad connected.");
            }
        }
