...
namespace Ludo.TwoHandsWar.Utilities.DebugHelper
{
    public class DebugTool : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            {
                Circumstance.Log.Logger.Log("1", "Temp");
            }
            if (keyboard.digit2Key.wasPressedThisFrame)
            {
                Circumstance.Log.Logger.Log("2", "Temp");
            }
            if (keyboard.digit3Key.wasPressedThisFrame)
            {
                Circumstance.Log.Logger.Log("3", "Temp");
            }
            if (keyboard.numpad1Key.wasPressedThisFrame)
            {
                Circumstance.Log.Logger.Log("【EasyDebug】 ManuallyNumpad1");
            }
