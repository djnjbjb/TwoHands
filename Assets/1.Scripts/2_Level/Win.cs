...
public class Win : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (timeBody == positionToSustainTime)
        {
            if (!ledJustShineBody)
            {
                ...
                playerControl.hcAudio.PlayLightUpBody();
            }
        }
        else
        {
        ...
        if (timeLeft == positionToSustainTime)
        {
            if (!ledJustShineLeft)
            {
                ...
                playerControl.hcAudio.PlayLightUpLeft();
            }
        }
        else
        {
        ...
        if (timeRight == positionToSustainTime)
        {
            if (!ledJustShineRight)
            {
                ...
                playerControl.hcAudio.PlayLightUpRight();
            }
        }
        else
        {
        ...
        else
        {
            ...
            if (timeSword == positionToSustainTime)
            {
                if (!ledJustShineSword)
                {
                    ...
                    playerControl.hcAudio.PlayLightUpSword();
                }
            }
            else
            {
    ...
    IEnumerator WinProcedure()
    {
        ...
        playerControl.hcAudio.BackGroundMusicFadeDown(backGroundMusicFadeDownTime, this);
        playerControl.hcAudio.PlayDoorOpen();
        ...
        playerControl.handFade.Fade(this, playerFadeTime);
